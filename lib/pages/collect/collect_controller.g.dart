...
mixin _$CollectController on CollectControllerBase, Store {
  late final _$collectiblesAtom =
      Atom(name: 'CollectControllerBase.collectibles', context: context);
  ...
  late final _$addCollectAsyncAction =
      AsyncAction('CollectControllerBase.addCollect', context: context);
  ...
  late final _$deleteCollectAsyncAction =
      AsyncAction('CollectControllerBase.deleteCollect', context: context);
