...
abstract class _PlayerController with Store {
  ...
  List<Danmaku> mergeDuplicateDanmakus(
    ...
    // 弹幕规范化处理
    // 去首尾空格并小写，全角转半角，去掉所有空白、标点符号，连续重复内容压缩
    for (var d in danmakus) {
      ...
      text = text.replaceAll(RegExp(r'[^\w\u4e00-\u9fff]'), '');
  ...
  void addDanmakus(List<Danmaku> danmakus) {
    ...
    final List<Danmaku> listToAdd  = danmakuDeduplicationEnable ? mergeDuplicateDanmakus(danmakus, timeWindowSeconds: 5) : danmakus;
