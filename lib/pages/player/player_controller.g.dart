...
mixin _$PlayerController on _PlayerController, Store {
  Computed<List<Danmaku>>? _$allDanmakusComputed;

  @override
  List<Danmaku> get allDanmakus => (_$allDanmakusComputed ??=
          Computed<List<Danmaku>>(() => super.allDanmakus,
              name: '_PlayerController.allDanmakus'))
      .value;
  ...
  void setDanmakuLoading(bool loading) {
    ...
    try {
      return super.setDanmakuLoading(loading);
    } finally {
  ...
  void clearDanmakus() {
    final _$actionInfo = _$_PlayerControllerActionController.startAction(
        name: '_PlayerController.clearDanmakus');
    try {
      return super.clearDanmakus();
    } finally {
      _$_PlayerControllerActionController.endAction(_$actionInfo);
    }
  }
  ...
  void addDanmakus(List<Danmaku> danmakus) {
    final _$actionInfo = _$_PlayerControllerActionController.startAction(
        name: '_PlayerController.addDanmakus');
    try {
      return super.addDanmakus(danmakus);
    } finally {
      _$_PlayerControllerActionController.endAction(_$actionInfo);
    }
  }
