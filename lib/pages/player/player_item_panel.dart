...
class PlayerItemPanel extends StatefulWidget {
  const PlayerItemPanel({
    ...
    required this.showDanmakuSettingsPanel,
  ...
  final VoidCallback showDanmakuSettingsPanel;
  final VoidCallback showMorePanel;
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      widget.keyboardFocus.requestFocus();
                                      widget.showDanmakuSettingsPanel();
                                    },
                                    color: Colors.white,
                      ...
                      menuChildren: [
                        StatefulBuilder(
                          builder: (context, setMenuState) {
                            int speedIndex = defaultPlaySpeedList
                                .indexOf(playerController.playerSpeed);
                            if (speedIndex < 0) {
                            ...
                            final double currentSpeed =
                                defaultPlaySpeedList[speedIndex];
                            return SizedBox(
                              width: 320,
                              child: Padding(
                                padding:
          ...
          child: MouseRegion(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  onPressed: widget.showMorePanel,
                  tooltip: '更多选项',
                  icon: const Icon(
                    Icons.more_vert,
                    color: Colors.white,
