...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void _focusCategory() {
    if (!isHandheldGamepadSupported()) return;
  ...
  void _previewCategory(String path) {
    if (!isHandheldGamepadSupported() || _wide != true) return;
    _detailScope.canRequestFocus = false;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (isHandheldGamepadSupported() && _wide != wide) {
        _wide = wide;
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (!mounted) return;
          if (_wide == true) {
                      ...
                      child: Offstage(
                        ...
                        child: GamepadFocusScope(
                          ...
                          child: _SettingsMenu(
                            ...
                            onFocusCategory: isHandheldGamepadSupported()
                                ? _previewCategory
                                : null,
